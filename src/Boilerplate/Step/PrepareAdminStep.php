...
class PrepareAdminStep extends BasicStep
{
    ...
    private function copyPage($pageName)
    {
        ...
        $toDir = $this->getConfiguration()->getOutputDir() . 'PrepareAdminStep.php/' . Configuration::PLUGIN_DIR . '/includes/pages';
    ...
    private function copyTemplate($pageName)
    {
        ...
        $toDir = $this->getConfiguration()->getOutputDir() . 'PrepareAdminStep.php/' . Configuration::PLUGIN_DIR . '/templates';
        $this->copyFile($pageName, $from, $toDir);
    }
